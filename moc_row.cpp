...
struct qt_meta_stringdata_Row_t {
    QByteArrayData data[2];
    char stringdata0[8];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_Row_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_Row_t qt_meta_stringdata_Row = {
    {
QT_MOC_LITERAL(0, 0, 3), // "Row"
QT_MOC_LITERAL(1, 4, 3) // "col"
...
static const uint qt_meta_data_Row[] = {
...
QT_INIT_METAOBJECT const QMetaObject Row::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_Row.data,
    qt_meta_data_Row,
    qt_static_metacall,
    nullptr,
    nullptr
...
void *Row::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_Row.stringdata0))
